...
Now you are ready to use eMoflon::IBeX HiPE.
...
## How to develop
1. Perform Steps (1) through (4) of the "How to install"-Section. Note: An eMoflon::IBeX installation is not required to develop for eMoflon::IBeX
...
Moflon::IBeX (Democles) feature to install eMoflon::IBeX along with the Democles pattern matching tool.
